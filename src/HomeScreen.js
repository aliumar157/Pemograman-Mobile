    ...
    <SafeAreaView>
      <ScrollView>
        <View style={{flex: 1}}>
          ...
          <View style={{backgroundColor: 'black', height: 260}}>
        ...
        <View style={{flex: 1}}>
          <View style={{paddingTop: '5%'}}>
            <Text style={{color: 'black', textAlign: 'center', fontSize: 28}}>Destinasi Wisata</Text>
            <Text style={{color: 'black', textAlign: 'center', fontSize: 14}}>Pilihan Terbaik</Text>
          </View>
        ...
        <View style={{flex: 1}}>
          <View style={{backgroundColor: 'black', marginHorizontal: '5%', paddingVertical: '10%', paddingHorizontal: '10%', borderRadius: 20}}>
        ...
        <View style={{flex: 1}}>
          ...
          alignItems: 'center', borderBottomWidth: 1, borderBottomColor: '#afafaf', marginHorizontal: '5%'}}>
            <Text style={{fontSize: 24, color: 'black'}}>Informasi dan Berita</Text>
            <Text style={{color: 'black'}}>Seputar Belitung Timur</Text>
          </View>
          <View style={{paddingHorizontal: '5%'}}>
            <View style={styles.newsContainer}>
              ...
              <View style={styles.newsInfo}>
                ...
                <Text style={{color: 'black'}}>20 Oktober 2021</Text>
              </View>
            </View>
            <View style={styles.newsContainer}>
              <View style={styles.newsImage}></View>
          ...
          <TouchableOpacity style={{paddingHorizontal: '5%', paddingVertical: '5%', alignItems: 'center'}}>
            <Text style={{fontSize: 18, color: 'black'}}>Informasi Lainnya</Text>
          </TouchableOpacity>
        </View>
      </ScrollView>
    </SafeAreaView>
